...
/usr/local/bin/protoc --proto_path=${project_base}/resources --java_out=${project_base}/generated ${project_base}/resources/filemessage.proto

#python build path
/usr/local/bin/protoc --proto_path=${project_base}/resources --python_out=${project_base}/generated ${project_base}/resources/common.proto
